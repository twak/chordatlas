...
1. [here is a tool](https://github.com/twak/panoscraper) that might help you download panoramas.
1. [here's another](https://github.com/twak/chordatlas/blob/bigsur_docker/src/org/twak/readTrace/ReadTrace.java) that might help you download meshes from online 3D services.
