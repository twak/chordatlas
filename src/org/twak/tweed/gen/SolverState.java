...
//							continue;
	...
	public void save( File location, boolean clean ) {
		try {
			...
			System.out.print( "writing state..." );
...
//	Map<Object, Object> old2New = new HashMap<>();
//	
//	create (mesh, old2New, removeMegaFacades );
//
//	for (Object o : old2New.keySet())
//		patch (old2New.get(o), old2New, removeMegaFacades);
//	
//	HalfMesh2 newMesh = (HalfMesh2) old2New.get(mesh);
//	
//	return new SolverState( newMesh, minis, globalProfs, profFit );
//}
//
//private void create( Object old, Map<Object, Object> old2New, boolean removeMegaFacades ) {
//	
//	if (old == null || old2New.containsKey( old )) 
//		return;
//
//	if (old instanceof HalfMesh2) {
//		
//		HalfMesh2 hf = (HalfMesh2) old;
//		HalfMesh2 neu = new HalfMesh2();
//		neu.faces = hf.faces;
//		
//		for (HalfFace f : hf)
//			create (f, old2New, removeMegaFacades );
//		
//		old2New.put( old, neu );
//	} 
//	else if (old instanceof HalfFace) {
//		
//		SuperFace oldF = (SuperFace)old;
//		SuperFace newF = new SuperFace (oldF);
//		
//		for (HalfEdge e : oldF)
//			create (e, old2New, removeMegaFacades) ;
//		
//		old2New.put( old, newF );
//	}
//	else if (old instanceof HalfEdge ) {
//		
//		SuperEdge oldE = (SuperEdge)old;
//		SuperEdge newE = new SuperEdge( oldE );
//		
//		if (newE.mini != null) {
//			newE.mini.clear();
//			for (MiniFacade mf : oldE.mini)
//				newE.mini.add(mf);
//		}
//		
//		old2New.put( old, newE );
//		
//		create (newE.next, old2New, removeMegaFacades);
//		create (newE.over, old2New, removeMegaFacades);
//		create (newE.face, old2New, removeMegaFacades);
//		
//		if (newE.profLine != null)
//			create (newE.profLine, old2New, removeMegaFacades);
//	}
//	else if (old instanceof Prof) {
//		Prof oldP = (Prof) old;
//		
//		Prof newP = new Prof (oldP);
//		newP.clear();
//		for (Point2d p : oldP)
//			newP.add(new Point2d(p));
//		
//		old2New.put (old, newP);
//	}
//	else if (old instanceof SuperLine) {
//		SuperLine nLine = new SuperLine ((SuperLine)old);
//		
//		if (removeMegaFacades)
//			nLine.properties.clear();
//		
//		old2New.put(old, nLine);
//	}
//	else throw new Error ("I don't knwo how to do that " + old.getClass() );
//}
//
//private void patch( Object o, Map<Object, Object> old2New, boolean removeMegaFacades ) {
//	
//	if (o instanceof HalfMesh2) {
//		
//		HalfMesh2 mesh = (HalfMesh2) o;
//		
//		List<HalfFace> nFaces = new ArrayList();
//		for (HalfFace f : mesh )
//			nFaces.add( (HalfFace) old2New.get( f ) );
//		
//		mesh.faces = nFaces;
//		
//	}
//	else if (o instanceof HalfFace) {
//		
//		SuperFace sf = (SuperFace)o;
//		sf.e = (HalfEdge) old2New.get( sf.e );
//		
//	} else if (o instanceof HalfEdge ) {
//		
//		SuperEdge oldE = (SuperEdge)o;
//		
//		oldE.next = (HalfEdge) old2New.get( oldE.next );
//		oldE.over = (HalfEdge) old2New.get( oldE.over );
//		oldE.prof = (Prof) old2New.get( oldE.prof );
//		oldE.face = (HalfFace) old2New.get( oldE.face );
//		oldE.profLine = (SuperLine) old2New.get( oldE.profLine );
//
//	} 
////	else if (o instanceof SuperLine) {
////		SuperLine nLine = (SuperLine) o;
////	}
////	else throw new Error ("I don't knwo how to do that");
//}
//