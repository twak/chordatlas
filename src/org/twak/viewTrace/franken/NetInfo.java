...
//	public Class<? extends App> appClass;
	...
	static {
		...
		index.put ( FacadeSuper.class, new NetInfo ( "super-facade", "super6", 8, 256 ) );
		index.put ( FacadeTexApp.class, new NetInfo ( "facade coarse", "facade_windows_f000", 8, 256 ) );
		index.put ( PanesLabelApp.class, new NetInfo ( "label windows", "dows2", 8, 256 ) );
		index.put ( PanesTexApp.class, new NetInfo ( "texture windows", "dows1", 8, 256 ) );
